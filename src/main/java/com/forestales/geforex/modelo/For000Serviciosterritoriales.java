...
public class For000Serviciosterritoriales implements Serializable {
	...
	@SequenceGenerator(name = "FOR_000_SERVICIOSTERRITORIALES_SETSERVICIOTERRITORIALID_GENERATOR", sequenceName = "FOR_000_SERVICIOSTERRITORIALES_SEQ", allocationSize = 1)
