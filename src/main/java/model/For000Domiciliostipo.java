...
@NamedQuery(name = "For000Domiciliostipo.findAll", query = "SELECT f FROM For000Domiciliostipo f")
public class For000Domiciliostipo implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name = "FOR_000_DOMICILIOSTIPOS_DOTDOMICILIOTIPOID_GENERATOR")
	...
	@OneToMany(mappedBy = "for000Domiciliostipo")
	private List<For000Domicilios> for000Domicilios;

	public For000Domiciliostipo() {
	}
