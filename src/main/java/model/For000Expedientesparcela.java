...
@NamedQuery(name="For000Expedientesparcela.findAll", query="SELECT f FROM For000Expedientesparcela f")
public class For000Expedientesparcela implements Serializable {
	...
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="FOR_000_EXPEDIENTESPARCELAS_EPAEXPEDIENTEPARCELAID_GENERATOR")
	...
	public For000Expedientesparcela() {
	}
